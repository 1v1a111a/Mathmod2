...
filter (eddypro, DOY > 133 & DOY < 150)
night = filter(nov_dec, daytime == "F")
...
teaching_tb1_unq = eddypro[teach,] 
 #вытаскиваем предсказанные значенияtesting_tb1_unq = eddypro[test,] 
